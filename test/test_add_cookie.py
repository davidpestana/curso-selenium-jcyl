...
URL_PAGE = 'https://psychic-space-giggle-6jv4rwv4crqwj-8080.app.github.dev/cookies.html'
class BaseChrome(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        # 1️⃣ Añadir una cookie personalizada
        cookie = {
            'name': 'curso_selenium',
            'value': 'activo',
            'path': '/',
            'domain': '.psychic-space-giggle-6jv4rwv4crqwj-8080.app.github.dev'
        }
        self.driver.add_cookie(cookie)
        print("✅ Cookie añadida:", cookie)
